    ...
    <div className="container border-top mt-5 mb-5">
      <div className="row mt-5 mb-5">
        <div className="col">
          ...
          <br></br>
          <br></br>
          <p className="text=muted" style={{ fontSize: "12px" }}>&copy; 2010 - 2025, Zerodha Broking Ltd. All rights reserved.</p>
        </div>
        <div className="col">
          <p>Company</p>
          <a href="">about</a>
      ...
      <p>
        Zerodha Broking Ltd.: Member of NSE, BS​ MCX SEBI Registration no.:
      ...
      <div className="footer-bottom text-center text-muted" style={{ fontSize: "12px" }}>
        <a href="#">NSE</a>
        <span> | </span>
        <a href="#">BSE</a>
        <span> | </span>
